...
## beta_mpg        2.0391 0.7063  0.02234        0.04881
## 
## 2. Quantiles for each variable:
## 
##                   2.5%     25%     50%    75%  97.5%
## beta_Intercept -1.4296 -0.7595 -0.4548 -0.134 0.4101
## beta_mpg        0.7872  1.5560  2.0039  2.464 3.5055
```
...
The `LINPRED` macro supports a handful of functions commonly included in formulas: `offset()`, `scale()`, and `I()`.
...
##     Ustar_Chick[1:2, 1:2] ~ dlkj_corr_cholesky(1.3, 2)
