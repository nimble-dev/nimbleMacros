...
The correlated random effects model here uses an [LKJ distribution prior](https://r-nimble.org/manual/cha-writing-models.html#lkj-distribution-for-correlation-matrices).
...
Which is best will depend on the model structure and the algorithm used with the model [as discussed in the NIMBLE user manual](https://r-nimble.org/manual/cha-writing-models.html#subsec:vectorized-versus-scalar-declarations).
