...
A macro is a (typically concise) piece of code in a model, usually a function, which NIMBLE expands into a larger amount of proper NIMBLE model code.
...
When we run `nimbleModel`, the macro is expanded according to the function we created earlier to generate the final valid NIMBLE model code.
